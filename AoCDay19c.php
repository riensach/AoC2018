...
$register6Values = array(0=>2,1=>3,2=>4,3=>5,4=>7,5=>8,6=>9,7=>10);
$puzzleRows = explode("\n",$trackGridInput);
$instructions = array();
...
while($instructionID < count($puzzleRows)) {
    ...
    //echo "Iteration $iterations After :: IP = $instructionPointer; IPValues = ".$registerValues[$instructionPointer]." - RegisterValues: 1:".$registerValues[0]." 2:".$registerValues[1]." 3:".$registerValues[2]." 4:".$registerValues[3]." 5:".$registerValues[4]." 6:".$registerValues[5]."<br><br>";
    if($registerValues[5]==2 && $loopStarted < 1) {
        // Started loop!
        echo "Started loop on iteration $iterations<br>";
        echo "Iteration $iterations After :: IP = $instructionPointer; IPValues = ".$registerValues[$instructionPointer]." - RegisterValues: 1:".$registerValues[0]." 2:".$registerValues[1]." 3:".$registerValues[2]." 4:".$registerValues[3]." 5:".$registerValues[4]." 6:".$registerValues[5]."<br><br>";
    
        $registerSixCounter = 0;
        $loopStarted = 1;
    }
    if($loopStarted > 0) {
        
        if($register6Values[$registerSixCounter]==$registerValues[5]) {
            // Loop continues
            $registerSixCounter++;
            if($registerSixCounter>7) {
                $registerSixCounter = 0;
            }
        } else {
            // Finished loop!            
            echo "Loop finished on iteration $iterations - ".$register6Values[$registerSixCounter]." - ".$registerValues[5]."<br>";
            echo "Iteration $iterations After :: IP = $instructionPointer; IPValues = ".$registerValues[$instructionPointer]." - RegisterValues: 1:".$registerValues[0]." 2:".$registerValues[1]." 3:".$registerValues[2]." 4:".$registerValues[3]." 5:".$registerValues[4]." 6:".$registerValues[5]."<br><br>";
    ...
    if ($instructionPointerValue == 2 && $registerValues[3] != 0) {
        echo "got here-<Br>";
        echo "Iteration $iterations After :: IP = $instructionPointer; IPValues = ".$registerValues[$instructionPointer]." - RegisterValues: 1:".$registerValues[0]." 2:".$registerValues[1]." 3:".$registerValues[2]." 4:".$registerValues[3]." 5:".$registerValues[4]." 6:".$registerValues[5]."<br><br>";
    if ($registerValues[4] % $registerValues[3] == 0) {
            $registerValues[0] = $registerValues[0]+$registerValues[4];
        }
        $registerValues[1] = 0;
        $registerValues[1] = $registerValues[5];
...
echo "After :: IP = $instructionPointer; IPValues = ".$registerValues[$instructionPointer]." - RegisterValues: 1:".$registerValues[0]." 2:".$registerValues[1]." 3:".$registerValues[2]." 4:".$registerValues[3]." 5:".$registerValues[4]." 6:".$registerValues[5]."<br><br>";
